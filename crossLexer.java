...
public class crossLexer extends Lexer {
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'print'", "'assign'", "'='", "'if'", "'then'", "'else'", "'while'", 
			"'do'", "'+'", "'-'", "'*'", "'/'", "'%'", "'('", "')'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, "STRING", "ID", "INT", "FLOAT", "WS"
		};
	}
	...
	public crossLexer(CharStream input) {
		super(input);
